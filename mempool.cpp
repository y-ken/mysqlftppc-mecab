...
static const char* ft_bytesFind(const char *haystack, size_t haystackLength, const char *needle, size_t needleLength){
...
static int ft_findShared(const char *base, size_t baseLength, size_t capacity, const char* token, size_t tokenLength){
